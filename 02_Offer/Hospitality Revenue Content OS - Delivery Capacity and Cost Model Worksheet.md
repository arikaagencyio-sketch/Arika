...
| 6 | Legal review path — counsel engagement (item 59) — *counsel named, letters unsigned; no drafted scope covers template review or the sub-processor register; MVP questions packaged 2026-09-14 (§11); **scope request sent to counsel 2026-09-16; the engagement is still not active, nothing signed or agreed, no review yet — awaiting reply*** | Legal (10) | Owner | G2 (legal effort), G5, QG4, contract, consent |
...
- **2026-09-16 — The narrowed-scope request was sent to counsel (item 59); G5 unchanged, still narrowed and not passed.** The owner sent the approved reply, which asked for a scope covering the six blocking matters and requested scope, deliverables, fee basis, timeline and what counsel needs — accepting neither unsigned letter, approving no fee and attaching nothing. **A request is not an agreed scope**, so G5 does not move and G2 stays blocked only by legal, with legal effort still unestimated. §7 G5, §8 #6 and §11.1 updated; **§11.6 deliberately unchanged** — its "nothing has been sent" refers to the MVP legal/privacy packet, which was **not** attached and remains unsent. **No prices, hours or money; still Working Hypothesis / Not Quotable.** — Claude Code (Opus 5)
...
| Tracker: **item 59** (engage counsel) — *updated 2026-09-16*: counsel identified, both letters unsigned, **the narrowed-scope request sent 2026-09-16**, scope not agreed, no review yet; blocked because the engagement is not active, not because no reviewer exists — **a request is not an agreed scope**, and counsel's reply is awaited. *(Was, re-stated 2026-09-14: "drafted reply unsent, scope not agreed".)* *Was, when this packet was written: "Its row still reads 'reply awaited' (2026-07-19) and predates both letters."* | `OWNER_INPUT_NEEDED.md` item 59 |
| ↪ **Scope request SENT to counsel 2026-09-16** — covering template review and the sub-processor register among the six blocking matters; neither unsigned letter accepted as-is. **A request is not an agreed scope and not an engagement** — nothing signed or agreed, nothing reviewed, reply awaited | `10_Legal/LEGAL_OS.md` §8; `10_Legal/LEGAL_REVIEW_PATH_DECISION_PACKET.md` |

**Result: no legal review path exists for the MVP's matters — G5 stays ❌, now narrowed but not passed.** *(2026-09-16: the owner decided the counsel scope is to be narrowed or amended before engagement, and **sent that request** the same day. It covers this packet's core matters — but **a request is not an agreed scope**: nothing is signed or agreed, no engagement is active and no document has been reviewed, so the gate does not move. Counsel's reply is awaited.)* Opening it is an owner action: an agreed engagement whose scope covers review of the templates cited in §11.4 and the sub-processor register for this MVP. When a review happens, `templates/README.md` requires the reviewer, date, changes and jurisdictions to be recorded in `LEGAL_OS.md` §8.
