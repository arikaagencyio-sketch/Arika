...
| 13 | **Audit scope and duration** (seed: "days", no figure). *Narrowed 2026-09-13: MVP minimum audit data set and data-sufficiency rule decided (Worksheet §1.4); audit duration still open* | Timeline; pricing | Owner | Gateway productization |
...
- **2026-09-13 — Cross-referenced the MVP minimum audit data set** (§9 #13, §12.5): eight data items and a data-sufficiency rule, internal design only. Full record in the Worksheet §1.4. Still **Not Quotable.** — Claude Code (Opus 5)
...
**MVP delivery scope approved for internal design only (2026-09-13):** Gateway audit + Entry Build Phase 1 (Direct Booking Message/Journey Blueprint), **H1/H2 properties only**; email/WhatsApp nurture implementation, the governance retainer and H3 are deferred. Record, outputs M1–M7 and readiness-gate effect: `Hospitality Revenue Content OS - Delivery Capacity and Cost Model Worksheet.md` §1.1. **This does not make any part of the offer quotable** — prices, a public offer, the retainer, test price figures, legal claims and performance guarantees all remain unapproved.
...
**MVP minimum audit data set approved for internal design only (2026-09-13):** eight data items — channel room-nights and revenue for the last three months, OTA commission, the current direct-booking path, guest communication assets, content and campaign assets, one buyer interview, and constraints. **Sufficiency rule:** without channel room-nights or the direct-booking path, the audit cannot proceed. Without revenue by channel, revenue leakage is unquantified. Without the buyer interview, the work is a desk review, not a diagnosis. Unknown commission is recorded as unknown, never invented. A dominant pricing/rate or booking-engine tech finding redirects rather than sells the Direct Booking Engine, consistent with §3. Record: Worksheet §1.4. **Not quotable.**

**MVP role-effort bands approved by the owner for internal planning only (2026-09-13):** owner/strategist L · offer engineer XS · content strategist M · sample-copy producer S · analytics/reporting M, or L when data is messy or revenue by channel is missing · delivery QA S, as owner self-review · legal/compliance BLOCKED, not estimated · design support and automation/booking-journey advisor deferred. No hours, costs, prices, floors or test figures. Readiness gate G2 is now blocked only by the legal review path. Record: Worksheet §10.8. Phase 11 stays **BLOCKED**; **not quotable.**
