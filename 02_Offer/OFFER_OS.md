...
**Cross-offer finding (2026-06-30):** offers #1 and #2 use **different, only-partially-overlapping internal team-role names** (offer #1: Sales Lead, Solutions Architect, Sales Ops Analyst, Data Analyst, Tech Lead, Content Specialist, Project Manager, QA Analyst; offer #2: Account Executive, Onboarding Specialist, Operations Analyst, Sales Analyst, Sales Strategist, Project Manager, Sales Enablement Lead, Content Designer, Legal; offer #3 adds yet another partially-overlapping set: Agency Lead, Strategy Lead, Infrastructure Specialist, Copywriter, List Specialist, Operations Specialist, Inbox Manager, Account Manager). Three data points now exist — still not reconciled into one canonical roster, but the pattern (each offer's chat session invents its own team-role names with partial overlap) is now well-established rather than assumed; worth a deliberate reconciliation pass once 1-2 more offers confirm it further, or now if the owner prefers.

**Note:** offer #1's own stated ICP (5-200 employees, $1M-$50M ARR) and offer #3's ICP ($500K-$50M ARR, Seed-Series B) are both narrower/differently-shaped than Sector (01)'s general real B2B SaaS ICP (Tier 1: Series A-C $5M-$50M ARR — `01_Sector/SECTOR_OS.md` §1). **Not yet reconciled** — flagged, not silently merged, same treatment as other cross-document ICP conflicts in this repo.
