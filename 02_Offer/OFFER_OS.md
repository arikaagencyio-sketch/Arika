...
- **⚠️ AI Opportunity Assessment — REOPENED 2026-07-15, contested, owner decision.** Routed to **AI Enablement (17)** by division association, then contradicted the same week by direct text: **`Draft 35` Phase 12 names "AI Opportunity Audit" as a standalone entry offer productized from offer #6 (Automation)** — *"same audit-as-entry-offer pattern as offer #10."* Split evidence: **"AI Opportunity"** → Automation (16); **"Assessment"** + the stated goal **"Introduce transformation"** → AI Enablement (17), matching offer #11's *"AI Readiness Assessment System"*. Direct textual evidence normally beats division association — but here the *name itself* is divided. **The by-division call is provisional, not settled.** Note the third possibility: offers #6 and #11 have *"the clearest two-offer sequencing relationship in the registry"* (`Draft 40` Phase 2), so an AI-opportunity entry offer could legitimately be the shared front door to both, owned by whichever department delivers what it uncovers.
