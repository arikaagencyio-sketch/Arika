...
**Empty skeleton.** No raw draft archive exists for this department. The few "Legal" mentions found elsewhere in the repo (in Branding, Client Success, and Sales raw drafts) are generic explainers of business-entity types, not the agency's own legal infrastructure (no MSA, SOW, DPA/privacy policy, IP terms, or claims-substantiation policy exists anywhere in the repo as of v0.1).
...
*(placeholder — empty; this department's primary registry once real content exists)*

## 10. Standards & SOPs Index

*(placeholder — no MSA, SOW, DPA, IP policy, or compliance procedure exists yet anywhere in the repo; highest-priority gap to close before onboarding any real client)*
...
None. This is a genuinely new department with no inherited backlog and no prior source content anywhere in the repo.
