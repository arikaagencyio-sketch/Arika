...
**Update 2026-08-02:** this intended shape is now fully specified as the **Content Distribution Engine** (`21_Presence/CONTENT_DISTRIBUTION_ENGINE.md`) — the plan-first, two-gate, 12-stage executable workflow across the 10 confirmed platforms, on Postiz (self-hosted, deployed via Railway). Owner-ratified design; reality-gated pre-build.
