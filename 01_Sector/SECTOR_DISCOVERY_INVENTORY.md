...
| **F2** | Two disjoint department vocabularies. DB3 `Routed To` = 5 values; DB7 `Departments Affected` = 7. Neither covers Design (19), Experience Engineering (20), Presence (21), Audits (14) or Client Success (07). | Composable workflows; every routing skill | **Owner decision** | recorded — proposed 21-value enum in `contracts/intelligence-object.schema.json` `$defs/department` |
