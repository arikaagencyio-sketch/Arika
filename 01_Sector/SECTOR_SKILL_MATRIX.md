...
**Department:** Sector (01) · **Version:** v0.6 (2026-08-28) · **Status:** Gate 3 — **Phases 1–2 built, Phase 3 begun.** `S01`–`S05` are live at `.claude/skills/` and have executed against Notion; S06–S12 remain contract-only.
...
| **3 · Prove it** ◐ **S05 built; F3 fixed** | S05, S06, S09 | Gates E/F. Fix the two mis-levelled Geography rows first. **Run the falsification test before loading more data.** |
