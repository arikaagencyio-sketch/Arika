...
**Reconciliation (2026-07-23) — Presence (21) coordinates; Marketing still owns distribution.** With the new Presence department established (`21_Presence/PRESENCE_OS.md`, the agency's Market Presence Infrastructure), this §10 platform-roles model is Marketing's *distribution-and-demand* view of presence, **consumed by** Presence's cross-layer coordination — not superseded by it. Marketing keeps channel/paid/demand-gen and SEO/AEO/GEO *strategy* (`marketing-seo-aeo-geo`); Presence owns the coordination of all presence layers (incl. the previously-unowned hidden layers and Engagement), the four-directions taxonomy (outreach/outbound/inbound/inreach), and the Presence Economics gate. The one-owner rule holds — no capability moved; a coordinator was added above them.
