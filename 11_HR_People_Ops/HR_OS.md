...
**Empty skeleton.** No raw draft archive exists for this department.
...
|---|---|---|---|---|---|
| *(placeholder — e.g. utilization rate, time-to-hire, once real content exists)* | | | | | |
...
*(placeholder — role scorecards, hiring process, internal onboarding/training, compensation framework)*
